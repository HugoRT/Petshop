                ...
                link: function(scope){
                    ...
                    scope.saveNewPet = function(){
                        ...
                        if (!scope.form.pet.name)
                            scope.form.errors.name = ["O nome é obrigatório"];
                        if (scope.form.pet.name.length > 30)
                            scope.form.errors.name = ["O nome não pode ter mais de 30 caracteres"];
                        if (!scope.form.pet.birthday)
                            scope.form.errors.birthday = ["Data de nascimento é obrigatória"];
